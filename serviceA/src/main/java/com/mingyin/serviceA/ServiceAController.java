...
public class ServiceAController implements ServiceAInterface {
    ...
    @Override
    public String sayHello(Long id, String name, String firstname, Integer age)
    {
        return "{'msg': 'hello, " + firstname + "'}";
    }
    ...
    @Override
    public String updateUser(String firstname, User user) {
        System.out.println("更新用户姓氏，firstname=" + firstname);
        return "{'msg': 'success'}";
    }
