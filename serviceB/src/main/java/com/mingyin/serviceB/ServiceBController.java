...
public class ServiceBController {
    ...
    public String greeting(@PathVariable("id") Long id,
        ...
        return serviceA.sayHello(id, name, firstname,age);
    }
    ...
    public String updateUser(@PathVariable("firstname") String firstname, @RequestBody User user)
    {
        return serviceA.updateUser(firstname, user);
    }
